...
public class Main {
    public static void main(String[] args) {
        ComicBookSalesman comicBookSalesman = new ComicBookSalesman(getComicBook());
        ...
        comicBookSalesman.writeOffComicBookByName("Могучие Рейнджеры");     // Списание комикса по имени
